...
const form = reactive({
    id: props.customer.id, name: props.customer.name, kana: props.customer.kana, tel: props.customer.tel, email: props.customer.email,
    postcode: props.customer.postcode, address: props.customer.address, birthday: props.customer.birthday, gender: props.customer.gender, memo: props.customer.memo
})
                            ...
                            <form @submit.prevent="updateCustomer(form.id)">
                                <div class="container px-5 py-24 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <label class="leading-7 mr-4 text-sm text-gray-600">性別</label>
                                            ...
                                            <input type="radio" id="other" v-model="form.gender" value="2">
